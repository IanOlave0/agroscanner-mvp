 ...
 * - parcelas: Terrenos del agricultor (polígono JSON, área m²)
 * - cultivos: Catálogo de cultivos (Limón, Papaya, Plátano)
 * - enfermedades: Catálogo de enfermedades (HLB, Shigatoka, Araña Roja)
 * - cultivo_enfermedad: Relación Muchos-a-Muchos + tratamiento específico
 * - detecciones: Historial de análisis de cultivos (con parcela y pin)
 * 
 * INTEGRIDAD REFERENCIAL:
 * - foreign_keys = ON (obligatorio para relación)
 */
